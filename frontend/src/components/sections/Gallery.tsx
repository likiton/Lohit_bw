...
const GALLERY_IMAGES = [
    { id: 1, title: "PRIVATE RIDE", description: "Calm reflective waters at Kerala Spot.", url: "src/images/gallery/HonnavarBoating28.webp" },
    { id: 2, title: "SHARAVATHI CHANNEL", description: "Natural corridors & soft gradients.", url: "src/images/gallery/HonnavarBoating22.webp" },
    { id: 3, title: "LOTUS POINT", description: "Bloom frames during seasonal peak.", url: "src/images/gallery/Screenshot_20250105-073619_Chrome-890x1024.webp" },
    { id: 4, title: "MANGROVE TUNNEL", description: "Filtered light & eco texture.", url: "src/images/gallery/OIP.webp" },
    { id: 5, title: "SUNSET ROUTE", description: "Golden reflections & silhouettes.", url: "src/images/gallery/BoatBridge-Honavar.webp?" },
    { id: 6, title: "QUIET DRIFT", description: "Private experience & space.", url: "src/images/gallery/11.webp" },
    { id: 7, title: "GOLDEN HOUR", description: "Edge light shimmer moments.", url: "src/images/gallery/image-5-1024x683.webp" },
    { id: 8, title: "KERALA FEEL", description: "Classic backwater aesthetic.", url: "src/images/gallery/allapey011.webp" },
];
